...
| Function          | Purpose                                                               |
|-------------------|-----------------------------------------------------------------------|
| `create_thesis()` | Scaffold a new Quarto project (standard or journal format)            |
| `policy_info()`   | Report the *Presentation of Theses Policy* version this build targets |

### Compliance

| Function              | Purpose                                           | Policy reference  |
|-----------------------|---------------------------------------------------|-------------------|
| `check_thesis()`      | Run all 18 source-phase rules and return a report | sections 7, 8, 13 |
| `validate_metadata()` | Lint the `uomthesis:` YAML block in `index.qmd`   | section 8         |
| `word_count()`        | Count main-text words vs the applicable cap       | section 4.6 fn. 1 |

### Citation styles

| Function     | Purpose                                             |
|--------------|-----------------------------------------------------|
| `list_csl()` | List the five bundled CSL styles with sha256 hashes |
| `copy_csl()` | Copy one of the bundled styles into a project       |
