...
- **A word counter** (`word_count()`) that counts “main text” per the
  policy’s definition (section 4.6 fn. 1) and checks against the
  applicable cap.
- **A compliance validator** (`check_thesis()`) that runs \~17
  source-phase rules against your project and produces console /
